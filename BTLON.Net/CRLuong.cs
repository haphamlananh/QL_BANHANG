...
namespace BTLON.Net {
    ...
    public class CRLuong : ReportClass {
    ...
    public class CachedCRLuong : Component, ICachedReport {
        
        public CachedCRLuong() {
        }
